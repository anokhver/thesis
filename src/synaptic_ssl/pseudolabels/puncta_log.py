"""LoG-based puncta pseudo-labels for fluorescence-microscopy MIPs.
...
`puncta_to_mask` and `restrict_puncta_to_near` are detector-agnostic
geometry helpers and live in `puncta_common`; they are re-exported here
for back-compat with `from synaptic_ssl.pseudolabels.puncta_log import ...`.
"""
