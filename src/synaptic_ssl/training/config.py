...
class SSLCfg:
    ...
    # collapses. 2048 stays tractable on a single GPU at the deepest stage.
    ...
    # deepest. Default -1 attaches heads to the deepest stage, which is what
    # both the from-scratch and MoBY-init runs in this repo use.
