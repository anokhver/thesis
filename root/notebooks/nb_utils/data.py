"""Dataset / dataloader / channel-stat helpers."""
...
_ROOT = _THIS.parents[2]  # root/
if str(_ROOT) not in sys.path:
    sys.path.insert(0, str(_ROOT))

from data_utils.patch_dataset import PatchDataset  # noqa: E402
...
def compute_channel_stats(
    ...
    """Streaming per-channel mean/std over a (C, H, W) Subset of [0,1] tensors."""
